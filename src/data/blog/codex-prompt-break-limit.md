...
tags:
  ...
  - AI
  - Agent
description: 以 Codex 为例，聊聊如何实现提示词“破限”。
---
...
我们可以在 [codex 官方仓库里查看最新的默认提示词](https://github.com/openai/codex/blob/main/codex-rs/protocol/src/prompts/base_instructions/default.md)
